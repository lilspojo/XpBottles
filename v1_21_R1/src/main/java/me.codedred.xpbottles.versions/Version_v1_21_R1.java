...
public class Version_v1_21_R1 implements VersionData {
	...
	public Version_v1_21_R1(Main plugin) {
		this.plugin = plugin;
	...
	public int getExpAmount(ItemStack item) {
		...
		return ((CompoundTag) compound.getList("AttributeModifiers", 10).get(0)).getInt("Amount");
	}
